  ...
  Session = (function() {
    ...
    function Session(url, apiKey, secret, params) {
      ...
      if (this.valid) {
        ...
        this.blogMetafield = new Metafield(this.blog, this.site());
        ...
        this.customCollectionMetafield = new Metafield(this.customCollection, this.site());
        this.customer = new Customer(this.site());
        this.customerMetafield = new Metafield(this.customer, this.site());
        ...
        this.orderMetafield = new Metafield(this.order, this.site());
        this.page = new Page(this.site());
        this.pageMetafield = new Metafield(this.product, this.site());
        this.product = new Product(this.site());
        this.productImage = new ProductImage(this.site());
        this.productMetafield = new Metafield(this.product, this.site());
        ...
        this.smartCollectionMetafield = new Metafield(this.smartCollection, this.site());
