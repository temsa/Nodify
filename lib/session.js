(function() {
  var ApplicationCharge, Article, Asset, Blog, Cart, Collect, Comment, Country, CustomCollection, Customer, CustomerGroup, Event, Fullfilment, Metafield, Order, Page, Product, ProductImage, ProductSearchEngine, ProductVariant, Province, RecurringApplicationCharge, Redirect, ScriptTags, Session, Shop, SmartCollection, Theme, Transaction, Webhook, crypto, empty, isNumeric, sortObj, trim, utils;
  ...
  Session = (function() {
    ...
    function Session(url, apiKey, secret, params) {
      ...
      if (this.params['error'] != null) this.error(this.params['error']);
      ...
      if (this.valid) {
        ...
        this.asset = new Asset('/themes', this.site());
        ...
        this.productVariantMetafield = new Metafield('/variants', this.site());
        ...
        this.shopMetafield = this.metafield;
        ...
        this.themeAsset = new Asset('/themes', this.site());
