(function() {
  var Blog, Order, Product, Resource, Session, SessionOAuth, empty, isNumeric, sortObj, trim, utils,
  ...
  SessionOAuth = (function(_super) {
    ...
    function SessionOAuth(store_name, api_key, secret, params) {
      ...
      this.registerOAuthToken = __bind(this.registerOAuthToken, this);
      this.site = __bind(this.site, this);
      this.requestTemporaryAccessToken = __bind(this.requestTemporaryAccessToken, this);
      this.requestPermanentAccessToken = __bind(this.requestPermanentAccessToken, this);
    ...
    SessionOAuth.prototype.onRedirectUrl = function(url, cb) {
      ...
      return url.replace(/\?code=[\w\d]+/, function(code) {
        ...
        return _this.requestPermanentAccessToken(temp_token, function(err, persistent_token) {
          _this.persistent_token = persistent_token;
          if (err) cb(err);
          _this.registerOAuthToken();
          return process.nextTick(function() {
            return cb(null, _this.store_name, _this.persistent_token);
          });
        });
      });
    };
    ...
    SessionOAuth.prototype.valid = function() {
      return !empty(this.url) && !empty(this.persistent_token);
    };
